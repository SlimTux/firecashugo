import{_ as I,g as h,a as C,b as D,C as O,r as N,F as _}from"./index.7e2b9467.js";/**
 * @license
 ...
 */const b="type.googleapis.com/google.protobuf.Int64Value",P="type.googleapis.com/google.protobuf.UInt64Value";function w(e,t){const n={};for(const r in e)e.hasOwnProperty(r)&&(n[r]=t(e[r]));return n}function p(e){if(e==null)return null;if(e instanceof Number&&(e=e.valueOf()),typeof e=="number"&&isFinite(e)||e===!0||e===!1||Object.prototype.toString.call(e)==="[object String]")return e;if(e instanceof Date)return e.toISOString();if(Array.isArray(e))return e.map(t=>p(t));if(typeof e=="function"||typeof e=="object")return w(e,t=>p(t));throw new Error("Data cannot be encoded in JSON: "+e)}function d(e){if(e==null)return e;if(e["@type"])switch(e["@type"]){case b:case P:{const t=Number(e.value);if(isNaN(t))throw new Error("Data cannot be decoded from JSON: "+e);return t}default:throw new Error("Data cannot be decoded from JSON: "+e)}return Array.isArray(e)?e.map(t=>d(t)):typeof e=="function"||typeof e=="object"?w(e,t=>d(t)):e}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const g="us-central1";function L(e){let t=null;return{promise:new Promise((n,r)=>{t=setTimeout(()=>{r(new u("deadline-exceeded","deadline-exceeded"))},e)}),cancel:()=>{t&&clearTimeout(t)}}}class R{constructor(t,n,r,i,o=g,s){this.app=t,this.fetchImpl=s,this.emulatorOrigin=null,this.contextProvider=new F(n,r,i),this.cancelAllRequests=new Promise(c=>{this.deleteService=()=>Promise.resolve(c())});try{const c=new URL(o);this.customDomain=c.origin,this.region=g}catch{this.customDomain=null,this.region=o}}_delete(){return this.deleteService()}_url(t){const n=this.app.options.projectId;return this.emulatorOrigin!==null?`${this.emulatorOrigin}/${n}/${this.region}/${t}`:this.customDomain!==null?`${this.customDomain}/${t}`:`https://${this.region}-${n}.cloudfunctions.net/${t}`}}function U(e,t,n){e.emulatorOrigin=`http://${t}:${n}`}function $(e,t,n){return r=>G(e,t,r,n||{})}function x(e,t,n){return r=>y(e,t,r,n||{})}async function M(e,t,n,r){n["Content-Type"]="application/json";let i;try{i=await r(e,{method:"POST",body:JSON.stringify(t),headers:n})}catch{return{status:0,json:null}}let o=null;try{o=await i.json()}catch{}return{status:i.status,json:o}}function G(e,t,n,r){const i=e._url(t);return y(e,i,n,r)}async function y(e,t,n,r){n=p(n);const i={data:n},o={},s=await e.contextProvider.getContext();s.authToken&&(o.Authorization="Bearer "+s.authToken),s.messagingToken&&(o["Firebase-Instance-ID-Token"]=s.messagingToken),s.appCheckToken!==null&&(o["X-Firebase-AppCheck"]=s.appCheckToken);const c=r.timeout||7e4,l=L(c),a=await Promise.race([M(t,i,o,e.fetchImpl),l.promise,e.cancelAllRequests]);if(l.cancel(),!a)throw new u("cancelled","Firebase Functions instance was deleted.");const E=v(a.status,a.json);if(E)throw E;if(!a.json)throw new u("internal","Response is not valid JSON object.");let f=a.json.data;if(typeof f>"u"&&(f=a.json.result),typeof f>"u")throw new u("internal","Response is missing data field.");return{data:d(f)}}const A="@firebase/functions",k="0.8.4";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function j(e=C(),t=g){return I(h(e),m).getImmediate({identifier:t})}function K(e,t,n){U(h(e),t,n)}function q(e,t,n){return $(h(e),t,n)}function z(e,t,n){return x(h(e),t,n)}B(fetch.bind(self));export{K as connectFunctionsEmulator,j as getFunctions,q as httpsCallable,z as httpsCallableFromURL};
